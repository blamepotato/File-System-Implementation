...
# Link
echo "Link Test 6"
wrappers/ext2_ln_hl runs/case6-ln-hard.img /level1/level2/bfile /bfilelink
echo "Link test 7"
wrappers/ext2_ln_sl runs/case7-ln-soft.img /level1/level2/bfile /bfilesoftlink
...
echo "Concurrency Test 13"
wrappers/ext2_concurrent_ln_hl runs/case13-concurrent-ln-hl.img
echo "Concurrency Test 14"
wrappers/ext2_concurrent_ln_sl runs/case14-concurrent-ln-sl.img
